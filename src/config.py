...
class Config:
    def __init__(self, config_path: str):
        ...
        self.default_prompts = {
            ...
            "approval_prompts": [
                "Evaluate this question-answer pair for completeness and accuracy. If the question is clearly and completely answered, return PASS. If there are minor issues that can be fixed, return CHANGE with improved versions. If there are major problems, return REJECT with explanation.",
                "Check the factual accuracy and consistency of this answer. If correct, return PASS. If it can be improved with better wording or more complete information while staying factual, return CHANGE. If factually incorrect, return REJECT.",
                "Assess if this question-answer pair would be useful for AI training. If it meets quality standards, return PASS. If it can be improved to meet standards, return CHANGE with better versions. If unsuitable for training, return REJECT.",
                [
